...
\begin{circuitikz}
    \begin{scope}[local bounding box=bb]
        ...
        \draw[DARCred](T-L2.east)
            |- (T.B1) node[currarrow, draw=DARCred]{}
            to [stroke diode, i={~}, draw=DARCred, fill=DARCred!10, -*] (C1)
            to [short, i={~}, draw=DARCred, -*] (h5)
            to [R, l={$R$}, *-*, i={~}, draw=DARCred] (h5|-a0) node[rground](){} coordinate(h7)
            to [short] (h7-|h6)
    ...
    \begin{scope}[shift={($(bb.south west)+(0,-2.25/\getDarcImageFactor)$)}]
        ...
        \fill[DARCblue!10] (axis cs:0,-1) rectangle (axis cs:1*pi,1);
